...
const HeaderMobile = () => {
  ...
  return (
    <header className="top-0 absolute right-0 left-0 z-[999]">
          ...
          <div className="flex h-[70px] w-full items-center justify-between px-6">
            ...
            <Link href="/">
              <div className="flex items-center">
                <h1
                  className={`${syne.className} text-[30px] font-bold text-primaryColor`}
                >
                  Domera
                </h1>
              </div>
            ...
            className="bg-transparent text-primaryColor shadow-none hover:bg-transparent"
            onClick={handleMenuToggle}
          >
            <MenuIcon style={{ width: '25px', height: '25px' }} strokeWidth={2.2} />
          </Button>
          </div>
        </div>
      </div>
