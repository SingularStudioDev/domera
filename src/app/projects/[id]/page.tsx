  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex gap-10">
            ...
            <div className="flex flex-col gap-10">
              <div className="flex items-start justify-between">
                ...
                <div className="mb-4">
                  <p className="mb-2 text-black">Desarrolla:</p>
                ...
                <div className="mb-8">
                  <p className="mb-2 text-black">Construye:</p>
                  <div className="flex gap-4">
                    <Image
      ...
      <footer className="bg-blue-900 text-white">
        <div className="container mx-auto" style={{ padding: '1.25rem' }}>
          <div className="flex items-center justify-center py-16">
            <div className="text-center">
              <h2 className="mb-4 text-2xl font-bold">Contacto</h2>
              <p className="text-lg">contacto@domera.com</p>
            </div>
          </div>
        </div>
      </footer>
