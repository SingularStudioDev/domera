...
export default function ChatPage() {
  ...
  return (
    <div className="flex h-[calc(100vh-120px)] flex-col rounded-xl border border-[#DCDCDC] bg-white shadow">
      {/* Header Bar */}
      <div className="flex h-[60px] items-center justify-between rounded-t-xl border-b border-[#DCDCDC] bg-white px-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            <Search className="absolute top-1/2 left-3 h-4 w-4 -translate-y-1/2 text-[#7B7B7B]" />
            <input
              type="text"
              placeholder="Buscar cliente..."
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="w-64 rounded-lg border border-[#DCDCDC] bg-white py-2 pr-4 pl-10 text-sm focus:border-[#0040FF] focus:ring-1 focus:ring-[#0040FF] focus:outline-none"
            />
          </div>
              ...
              <div
                ...
                className={cn(
                  ...
                  selectedChat === chat.id
                    ? "bg-[#005BFF] text-white hover:bg-[#005BFF]"
                    : "bg-white",
                )}
              >
                <div className="relative">
                  ...
                  >
                    <div
                      className={cn(
                        ...
                        msg.sender === "client"
                          ? "border border-[#DCDCDC] bg-white text-gray-900"
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <input
                      ...
                      className="w-full rounded-lg border border-[#DCDCDC] bg-white px-4 py-3 text-sm focus:border-[#0040FF] focus:ring-1 focus:ring-[#0040FF] focus:outline-none"
                    />
                  </div>
